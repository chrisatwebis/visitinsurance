...
<?php
	...
	$img_width = variable_get("drokstories_imgwidth", '');
				...
				<div class="description">
					...
					<div class="readon-wrap1">
						<div class="readon1-l"></div>
							<a href="<?php echo $preURL; ?>node/<?php echo $anode->nid; ?>" title="<?php echo $anode->title; ?>" class="readon-main"><span class="readon1-m"><span class="readon1-r">Read the Full Story</span></span></a>
					</div>
					<div class="clr"></div>
				</div>
