				...
				<div id="top-bar">
					<div class="topbar-strip">
						...
						<div class="date-block">
							<div id="site-contact">
							<?php print t("Call us at <code>647-515-9368 (Toronto), 514-606-6767 (Quebec), 1-877-580-9719</code> (Other Regions In Canada) or <a href='@url'>Contact Us</a>", array("@url"=>url("webform/contact-us")));?>
							</div>
						</div>
